...
jQuery.support = (function( support ) {
	...
	// Support: IE<9 (lack submit/change bubble), Firefox 17.png+ (lack focusin event)
...
if ( window.getComputedStyle ) {
	...
	curCSS = function( elem, name, _computed ) {
		...
		if ( computed ) {
			...
			// Chrome < 17.png and Safari 5.0 uses "computed value" instead of "used value" for margin-right
